...
namespace DbFirstEntityFrameworkApp.DBFirstModel
{
    using System;
    ...
    public partial class Library2Entities1 : DbContext
    {
        public Library2Entities1()
            : base("name=Library2Entities1")
        {
            this.Configuration.LazyLoadingEnabled = false;//Eagar loading activated
        }
